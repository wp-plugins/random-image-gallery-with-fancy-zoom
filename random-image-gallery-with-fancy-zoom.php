...
function rigwfz_admin_option() 
{
	...
	<ul>
	<li>Check official website for more info <a target="_blank" href='http://www.gopipulse.com/work/2010/07/18/random-image-gallery-with-fancy-zoom/'>Click here</a></li>
    </ul>
	<?php
	echo "</div>";
}
