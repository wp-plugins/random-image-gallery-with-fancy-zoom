...
function rigwfz_show_filter_callback($matches) 
{
	...
	$rigwfz = $rigwfz . " $('#nooverlay').fancyzoom({Speed:400,showoverlay:false}); ";
	$rigwfz = $rigwfz . ' }); ';
	$rigwfz = $rigwfz . ' </script> ';
	
	$rigwfz = $rigwfz . '<div>';
	$rigwfz = $rigwfz . '<a href="'.$rigwfz_siteurl . $image .'" id="nooverlay">';
...
function rigwfz_admin_option() 
{
	...
	Check official website for more info and live demo <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/random-image-gallery-with-fancy-zoom/'>Click here</a><br> 
    <br>
	<?php
	echo "</div>";
}
