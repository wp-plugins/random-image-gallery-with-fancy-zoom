...
function rigwfz_add_javascript_files() 
{
	if (!is_admin())
	{
		wp_enqueue_script( 'FancyZoom', get_option('siteurl').'/wp-content/plugins/random-image-gallery-with-fancy-zoom/rigwfz_js/FZoom.js');
		wp_enqueue_script( 'FancyZoomHTML', get_option('siteurl').'/wp-content/plugins/random-image-gallery-with-fancy-zoom/rigwfz_js/FZoomHtml.js');
	}	
}
