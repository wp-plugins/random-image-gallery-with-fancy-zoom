...
function rigwfz_admin_option() 
{
	...
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/random-image-gallery-with-fancy-zoom/'>Click here</a> to find more information and user comments. <br> 
	<h2>Other related plugin</h2>
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/random-image-gallery-with-fancy-zoom/'>Random image gallery with fancy zoom</a> <br />
    <a target="_blank" href='http://www.gopiplus.com/work/2011/05/08/wordpress-plugin-image-horizontal-reel-scroll-slideshow/'>Image horizontal reel scroll slideshow</a> <br />
    <a target="_blank" href='http://www.gopiplus.com/work/2011/04/25/wordpress-plugin-left-right-image-slideshow-gallery/'>Left right image slideshow gallery</a> <br />
    <br>
	<?php
	echo "</div>";
}
...
function rigwfz_control()
{
	...
	Plug-in created by <a target="_blank" href='http://www.gopiplus.com/'>Gopi</a>. <br> 
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/random-image-gallery-with-fancy-zoom/'>Click here</a> for help and suggestion. <br> 
	<?php	
}
...
function rigwfz_widget_init() 
{
	...
	{
		register_widget_control(array('R I G W F Z', 'widgets'), 'rigwfz_control');
	} 
}
